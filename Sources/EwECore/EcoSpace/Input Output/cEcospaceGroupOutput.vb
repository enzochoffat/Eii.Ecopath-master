...
#Region "Constructor"
    ...
    Public Sub New(core As cCore, EcoSpaceData As cEcospaceDataStructures, iGroup As Integer)
        MyBase.New(core)
        ...
        'no validators
        'no validators
        val = New cValue(core, 0, eVarNameFlags.EcospaceGroupBiomassStart, eStatusFlags.OK, eValueTypes.Sng)
        Me.m_values.Add(val.varName, val)

        val = New cValue(core, 0, eVarNameFlags.EcospaceGroupBiomassEnd, eStatusFlags.OK, eValueTypes.Sng)
        Me.m_values.Add(val.varName, val)

        'no validators
        val = New cValueArray(core, eValueTypes.SingleArray, eVarNameFlags.EcospaceGroupCatchEnd, eStatusFlags.OK, eCoreCounterTypes.nFleets)
        Me.m_values.Add(val.varName, val)

        val = New cValueArray(core, eValueTypes.SingleArray, eVarNameFlags.EcospaceGroupCatchStart, eStatusFlags.OK, eCoreCounterTypes.nFleets)
        Me.m_values.Add(val.varName, val)

        'no validators
        val = New cValueArray(core, eValueTypes.SingleArray, eVarNameFlags.EcospaceGroupValueStart, eStatusFlags.OK, eCoreCounterTypes.nFleets)
        Me.m_values.Add(val.varName, val)

        val = New cValueArray(core, eValueTypes.SingleArray, eVarNameFlags.EcospaceGroupValueEnd, eStatusFlags.OK, eCoreCounterTypes.nFleets)
        Me.m_values.Add(val.varName, val)
    ...
    Public Sub Init()
        ...
        Me.m_CoreData.Add(eVarNameFlags.EcospaceBiomassOverTime, New c3DResultsWrapper2Fixed(Me.m_spaceData.ResultsByGroup, eSpaceResultsGroups.Biomass, Me.Index))
        Me.m_CoreData.Add(eVarNameFlags.EcospaceRelativeBiomassOverTime, New c3DResultsWrapper2Fixed(Me.m_spaceData.ResultsByGroup, eSpaceResultsGroups.RelativeBiomass, Me.Index))
        Me.m_CoreData.Add(eVarNameFlags.EcospaceGroupValueOverTime, New c3DResultsWrapper2Fixed(Me.m_spaceData.ResultsByGroup, eSpaceResultsGroups.Value, Me.Index))
        Me.m_CoreData.Add(eVarNameFlags.EcospaceGroupCatchOverTime, New c3DResultsWrapper2Fixed(Me.m_spaceData.ResultsByGroup, eSpaceResultsGroups.CatchBio, Me.Index))
...
#Region "Properties via dot '.' operator"
    ...
    Public ReadOnly Property Biomass(iTime As Integer) As Single
        ...
        Get
            Return CSng(Me.GetVariable(eVarNameFlags.EcospaceBiomassOverTime, iTime))
        End Get

    End Property

    Public ReadOnly Property RelativeBiomass(iTime As Integer) As Single

        Get
            Return CSng(Me.GetVariable(eVarNameFlags.EcospaceRelativeBiomassOverTime, iTime))
        End Get

    End Property

    Public ReadOnly Property CatchBiomass(iFleet As Integer, iTime As Integer) As Single

        Get
            Return CSng(Me.GetVariable(eVarNameFlags.EcospaceGroupCatchOverTime, iFleet, iTime))
        End Get

    End Property

    Public ReadOnly Property Value(iFleet As Integer, iTime As Integer) As Single

        Get
            Return CSng(Me.GetVariable(eVarNameFlags.EcospaceGroupValueOverTime, iFleet, iTime))
        End Get
...
#Region "Properties via dot '.' operator"
    ...
    Public Property BiomassStart() As Single
        Get
            Return CSng(Me.GetVariable(eVarNameFlags.EcospaceGroupBiomassStart))
        End Get

        Set(value As Single)
            Me.SetVariable(eVarNameFlags.EcospaceGroupBiomassStart, value)
        End Set
    End Property

    Public Property BiomassEnd() As Single
        Get
            Return CSng(Me.GetVariable(eVarNameFlags.EcospaceGroupBiomassEnd))
        End Get

        Set(value As Single)
            Me.SetVariable(eVarNameFlags.EcospaceGroupBiomassEnd, value)
        End Set
    End Property
    ...
    Public Property CatchStart(iFleet As Integer) As Single
        ...
        Set(value As Single)
            Me.SetVariable(eVarNameFlags.EcospaceGroupCatchStart, value, iFleet)
        End Set
    End Property
    ...
    Public Property ValueStart(iFleet As Integer) As Single
        Get
            Return CSng(Me.GetVariable(eVarNameFlags.EcospaceGroupValueStart, iFleet))
        End Get

        Set(value As Single)
            Me.SetVariable(eVarNameFlags.EcospaceGroupValueStart, value, iFleet)
        End Set
    End Property

    Public Property ValueEnd(iFleet As Integer) As Single
        Get
            Return CSng(Me.GetVariable(eVarNameFlags.EcospaceGroupValueEnd, iFleet))
        End Get
...
#Region "Status via dot '.' operator"
    ...
    Public Property BiomassStartStatus() As eStatusFlags
        Get
            Return Me.GetStatus(eVarNameFlags.EcospaceGroupBiomassStart)
        End Get

        Set(value As eStatusFlags)
            Me.SetStatus(eVarNameFlags.EcospaceGroupBiomassStart, value)
        End Set
    End Property

    Public Property BiomassEndStatus() As eStatusFlags
        Get
            Return Me.GetStatus(eVarNameFlags.EcospaceGroupBiomassEnd)
        End Get

        Set(value As eStatusFlags)
            Me.SetStatus(eVarNameFlags.EcospaceGroupBiomassEnd, value)
        End Set
    End Property
    ...
    Public Property CatchStartBiomassStatus(IFleet As Integer) As eStatusFlags
        ...
        Set(value As eStatusFlags)
            Me.SetStatus(eVarNameFlags.EcospaceGroupCatchStart, value, IFleet)
        End Set
    End Property
    ...
    Public Property ValueStartStatus(IFleet As Integer) As eStatusFlags
        Get
            Return Me.GetStatus(eVarNameFlags.EcospaceGroupValueStart, IFleet)
        End Get

        Set(value As eStatusFlags)
            Me.SetStatus(eVarNameFlags.EcospaceGroupValueStart, value, IFleet)
        End Set
    End Property

    Public Property ValueEndStatus(IFleet As Integer) As eStatusFlags
        Get
            Return Me.GetStatus(eVarNameFlags.EcospaceGroupValueEnd, IFleet)
        End Get

        Set(value As eStatusFlags)
            Me.SetStatus(eVarNameFlags.EcospaceGroupValueEnd, value, IFleet)
        End Set
    End Property
