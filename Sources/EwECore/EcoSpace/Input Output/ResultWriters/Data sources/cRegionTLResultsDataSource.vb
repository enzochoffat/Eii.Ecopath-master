...
''' </remarks>
Public Class cRegionTLResultsDataSource
    ...
    Public Overrides Function GetResult(OneBasedIndex As Integer, TimeIndex As Integer) As Single
        Try
            ...
            Return Me.m_spaceData.ResultsRegionTLGroup(RegionOb.RegionIndex, RegionOb.GroupIndex, TimeIndex)
    ...
    Public Overrides ReadOnly Property FilenameIdentifier As String
        Get
            Return "Region_" + Me.m_RegionIndex.ToString + "_TL"
        End Get
    End Property
    ...
    Public Overrides ReadOnly Property DataDescriptor As String
        Get
            ...
            Return My.Resources.CoreDefaults.ECOSPACE_REGAVG_TL
        End Get
    End Property
