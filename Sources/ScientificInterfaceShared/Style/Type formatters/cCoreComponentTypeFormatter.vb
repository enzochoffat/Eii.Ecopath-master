...
Namespace Style
    ...
    ''' ---------------------------------------------------------------------------
    ''' <summary>
    ''' Class for providing a textual description of <see cref="eCoreComponentType"/>.
    ''' </summary>
    ''' <remarks>
    ...
    ''' </remarks>
    ''' ---------------------------------------------------------------------------
    Public Class cCoreComponentTypeFormatter
        ...
        Public Overloads Function ToString(value As Object, Optional descriptor As eDescriptorTypes = eDescriptorTypes.Name) As String _
            ...
            Dim strDescr As String = cResourceUtils.LoadString("CORECOMPONENT_" & strValue.ToUpper, My.Resources.ResourceManager)
