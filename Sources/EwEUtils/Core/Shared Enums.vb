...
#Region " Variable names "
    ...
    Public Enum eVarNameFlags As Integer
        ...
        ''' <summary>Ecospace Landings by fleet and group averaged over all the cells in a region for each timestep.
        EcospaceRegionLandings
        ''' <summary>Ecospace Value by fleet and group averaged over all the cells in a region for each timestep.
        EcospaceRegionValue
        ''' <summary>Ecospace trophic level by group averaged over all the cells in a region for each timestep.
        EcospaceRegionTL
