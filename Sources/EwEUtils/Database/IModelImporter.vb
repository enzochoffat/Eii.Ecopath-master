...
Namespace Database
    ...
    Public Interface IModelImporter
        ...
        ''' </remarks>
        ''' -------------------------------------------------------------------
        Function Open(strSource As String) As Boolean
        ...
        ''' <returns>True if successful.</returns>
        ''' -------------------------------------------------------------------
        Function Import(info As cExternalModelInfo, _
        ...
        ''' -------------------------------------------------------------------
        Function CanImportFrom(strSource As String) As Boolean
    ...
    Public Class cExternalModelInfo
        ...
        ''' ---------------------------------------------------------------
        Public Sub New(strID As String, strName As String, strDescription As String, nScenarios As Integer)
            Me.m_strID = strID
