...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Looks up a localized string similar to Generate Ecopath models from Ecosim time steps.
        '''</summary>
        Friend ReadOnly Property DISPLAY_TOOLTIP() As String
            Get
                Return ResourceManager.GetString("DISPLAY_TOOLTIP", resourceCulture)
            End Get
        End Property
