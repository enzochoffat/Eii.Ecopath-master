...
#Region " Private vars "
    ...
    Private ReadOnly m_logger As ILogger = LoggingContext.CreateLogger(Of cCConcSpatialRaster)()
...
#Region " Construction / destruction "
    ...
    ''' </summary>
    ''' -------------------------------------------------------------------
    Public Sub New(bm As cEcospaceBasemap, ds As cEcospaceDataStructures, iGroup As Integer)
        Me.m_bm = bm
        Me.m_ds = ds
        Me.m_iGroup = iGroup
    End Sub
...
#Region " Public access "
    ...
    Public Overrides Function ToString() As String
        Return "Ecotracer CConc(" & Me.m_iGroup & ")"
    End Function
