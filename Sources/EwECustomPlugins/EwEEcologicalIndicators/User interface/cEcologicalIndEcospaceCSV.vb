...
''' setting
''' </summary>
Public Class cEcologicalIndEcospaceCSV
    Implements IAutoSavePlugin

    Public Const PluginName As String = "EwEEcoIndPluginAutosaveEcospaceCSV"

    Public Property AutoSave As Boolean Implements IAutoSavePlugin.AutoSave
        Get
            Return My.Settings.AutoSaveEcospaceCSV
        End Get
        Set(value As Boolean)
            My.Settings.AutoSaveEcospaceCSV = value
            My.Settings.Save()
        End Set
    End Property
    ...
    Public ReadOnly Property Description As String Implements IPlugin.Description
        Get
            Return cStringUtils.Localize(SharedResources.GENERIC_LABEL_DETAILED, My.Resources.DISPLAYNAME, "Ecospace CSV")
        End Get
    End Property
