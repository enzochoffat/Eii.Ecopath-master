...
''' setting
''' </summary>
Public Class cEcologicalIndEcosimCSV
    Implements IAutoSavePlugin

    Public Const PluginName As String = "EwEEcoIndPluginAutosaveEcosim"

    Public Property AutoSave As Boolean Implements IAutoSavePlugin.AutoSave
        Get
            Return My.Settings.AutoSaveEcosim
        End Get
        Set(value As Boolean)
            My.Settings.AutoSaveEcosim = value
            My.Settings.Save()
        End Set
    End Property
    ...
    Public ReadOnly Property Description As String Implements IPlugin.Description
        Get
            Return cStringUtils.Localize(SharedResources.GENERIC_LABEL_DETAILED, My.Resources.DISPLAYNAME, "Ecosim CSV")
        End Get
    End Property
