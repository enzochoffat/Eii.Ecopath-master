...
Partial Class ucDefaults
    ...
    Private Sub InitializeComponent()
        ...
        Me.m_lbWholesaler = New ucUnitDefault()
        Me.m_lbRetailer = New ucUnitDefault()
        Me.m_lbConsumer = New ucUnitDefault()
        Me.m_lnkProd2Proc = New ucLinkDefault()
        Me.m_lnkProc2Dist = New ucLinkDefault()
        Me.m_lnkWhole2Ret = New ucLinkDefault()
        Me.m_lnkRet2Cons = New ucLinkDefault()
        Me.m_lbDistribution = New ucUnitDefault()
        Me.m_lnkDist2Whole = New ucLinkDefault()
        ...
        Me.m_lbProducer.UnitType = cUnitFactory.eUnitType.Producer
        '
        'm_lbProcessing
        '
        ...
        Me.m_lbProcessing.UnitType = cUnitFactory.eUnitType.Processing
        '
        'm_lbWholesaler
        '
        ...
        Me.m_lbWholesaler.UnitType = cUnitFactory.eUnitType.Wholesaler
        '
        'm_lbRetailer
        '
        ...
        Me.m_lbRetailer.UnitType = cUnitFactory.eUnitType.Retailer
        '
        'm_lbConsumer
        '
        ...
        Me.m_lbConsumer.UnitType = cUnitFactory.eUnitType.Consumer
        '
        'm_lnkProd2Proc
        '
        ...
        Me.m_lbDistribution.UnitType = cUnitFactory.eUnitType.Distribution
        '
        'm_lnkDist2Whole
        '
    ...
    Private WithEvents m_lnkDist2Whole As ucLinkDefault
    Private WithEvents m_lbDistribution As ucUnitDefault
End Class
