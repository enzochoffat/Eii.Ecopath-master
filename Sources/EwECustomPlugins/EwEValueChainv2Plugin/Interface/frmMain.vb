...
#Region " Vars "
    ...
    Private m_plugin As cValueChainPluginV2 = Nothing
...
#Region " Constructor "
    ...
    Public Sub New(plugin As cValueChainPluginV2)
    ...
    Public Sub ShowForm(page As eValueChainPageTypes)
        ...
        Select Case Me.m_pageCurrent
            ...
            Case eValueChainPageTypes.Run
                Me.ShowForm(New ucResults(Me.m_plugin.Context, Me.m_plugin.Data, Me.m_plugin.Controller, Me.m_plugin.Results), My.Resources.NAVTREE_OUTPUT_RUN)
            Case eValueChainPageTypes.FlowDiagram
                Me.ShowForm(New ucFlowDiagram(Me.m_plugin.Context, Me.m_plugin.Data, Me.m_plugin.Controller, Me.m_plugin.Results), My.Resources.NAVTREE_OUTPUT_FLOWDIAGRAM)
            Case Else
                Debug.Assert(False)
        End Select
