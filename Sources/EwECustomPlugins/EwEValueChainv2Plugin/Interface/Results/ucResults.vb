...
#Region " Constructor "
    ...
    Public Sub New(uic As cUIContext, data As cValueChainData, model As cValueChainController, result As cValueChainResults)
...
#Region " Events "
    ...
    Protected Overrides Sub OnLoad(e As System.EventArgs)
        ...
        ' Initialize view
        Select Case Me.m_model.RunType
            Case cValueChainController.eRunTypes.Ecopath : Me.SetViewMode(eViewModeType.Grid)
            Case cValueChainController.eRunTypes.Ecosim : Me.SetViewMode(eViewModeType.Graph)
            Case cValueChainController.eRunTypes.Equilibrium : Me.SetViewMode(eViewModeType.GraphEquilibrium)
        End Select
    ...
    Private Sub OnGraphDataSelectionChanged(sender As System.Object, e As System.EventArgs) _
        ...
        Me.SetGraphData(DirectCast(Me.m_tscmbGraphData.SelectedItem, cValueChainResults.eGraphDataType))
        Me.UpdateResults()
    End Sub
...
#Region " Commands "
    ...
    Private Sub OnInvokeRunEcopath(cmd As cCommand)
        ...
        Try
            ...
            Me.m_result.Reset(Me.m_core.nFleets, Me.m_core.nGroups, 0)
