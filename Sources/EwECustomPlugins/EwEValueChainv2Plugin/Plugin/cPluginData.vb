...
Public Class cPluginData
    ...
    Public Class cVCEconomicValueChainData
        Implements IEData
...
#Region " Privates "
    ...
    Private m_totals As New cVCEconomicValueChainData()

    Friend m_runType As IRunType = Nothing
    Friend m_iTimeStep As Integer = 0
    Friend m_subtotals As New List(Of cVCEconomicValueChainData)
...
#Region " Helper methods "
    ...
    Friend Sub Resize(nFleets As Integer)
        ...
        For iFleet As Integer = 0 To nFleets - 1
            Me.m_subtotals.Add(New cVCEconomicValueChainData)
        Next
    End Sub
