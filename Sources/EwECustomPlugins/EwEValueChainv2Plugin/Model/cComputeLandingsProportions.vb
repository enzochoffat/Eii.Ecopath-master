...
Public Class cComputeLandingPortions
    ...
    Public Sub New(core As cCore, data As cValueChainData, iTimeStep As Integer, runType As cValueChainController.eRunTypes)
        Me.Compute(core, data, iTimeStep, runType)
    End Sub

    Private Function Compute(core As cCore, data As cValueChainData, iTimeStep As Integer, runType As cValueChainController.eRunTypes) As Boolean
