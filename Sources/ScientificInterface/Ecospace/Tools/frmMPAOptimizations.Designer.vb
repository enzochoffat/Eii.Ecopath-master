...
Namespace Ecospace
    ...
    Partial Class frmMPAOptimizations
        ...
        Private Sub InitializeComponent()
            ...
            Me.m_tlpParms = New System.Windows.Forms.TableLayoutPanel()
            ...
            Me.m_tlpResults = New System.Windows.Forms.TableLayoutPanel()
            Me.m_plResults = New System.Windows.Forms.Panel()
            Me.m_scRes2 = New System.Windows.Forms.SplitContainer()
            ...
            Me.m_tlpResults.SuspendLayout()
            Me.m_plResults.SuspendLayout()
            CType(Me.m_scRes2, System.ComponentModel.ISupportInitialize).BeginInit()
            Me.m_scRes2.Panel1.SuspendLayout()
            Me.m_scRes2.Panel2.SuspendLayout()
            Me.m_scRes2.SuspendLayout()
            Me.SuspendLayout()
            '
            'm_btnRun
            '
            ...
            'm_tpProgress
            '
            Me.m_tpProgress.Controls.Add(Me.m_scResults)
            ...
            'm_scResults
            '
            resources.ApplyResources(Me.m_scResults, "m_scResults")
            Me.m_scResults.Name = "m_scResults"
            '
            'm_scResults.Panel1
            '
            Me.m_scResults.Panel1.Controls.Add(Me.m_gridProgress)
            '
            'm_scResults.Panel2
            '
            Me.m_scResults.Panel2.Controls.Add(Me.m_graphProgress)
            '
            'm_gridProgress
            '
            ...
            'm_tpResults
            '
            Me.m_tpResults.Controls.Add(Me.m_tlpResults)
            ...
            Me.m_tlbParameters.Controls.Add(Me.m_cbUseRegions, 6, 2)
            ...
            'm_tabParameters
            '
            Me.m_tabParameters.Controls.Add(Me.m_tlpParms)
            ...
            'm_tlpParms
            '
            resources.ApplyResources(Me.m_tlpParms, "m_tlpParms")
            Me.m_tlpParms.Controls.Add(Me.m_tlbParameters, 0, 0)
            Me.m_tlpParms.Controls.Add(Me.m_tlpObjectives, 0, 1)
            Me.m_tlpParms.Name = "m_tlpParms"
            '
            'm_tlpObjectives
            '
            ...
            Me.m_tlpMap.Controls.Add(Me.m_tsMap, 0, 0)
            ...
            Me.m_scMap.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
            ...
            'm_tlpResults
            '
            resources.ApplyResources(Me.m_tlpResults, "m_tlpResults")
            Me.m_tlpResults.Controls.Add(Me.m_plResults, 0, 0)
            Me.m_tlpResults.Controls.Add(Me.m_scRes2, 0, 1)
            Me.m_tlpResults.Name = "m_tlpResults"
            '
            'm_plResults
            '
            Me.m_plResults.Controls.Add(Me.m_lblAreaClosed)
            Me.m_plResults.Controls.Add(Me.m_btnSave)
            Me.m_plResults.Controls.Add(Me.m_cmbAreaClosed)
            Me.m_plResults.Controls.Add(Me.m_btnResetMPAs)
            Me.m_plResults.Controls.Add(Me.m_btnConvertToMpa)
            Me.m_plResults.Controls.Add(Me.m_nudBestPercentile)
            Me.m_plResults.Controls.Add(Me.m_lblBestPercentile)
            resources.ApplyResources(Me.m_plResults, "m_plResults")
            Me.m_plResults.Name = "m_plResults"
            '
            'm_scRes2
            '
            resources.ApplyResources(Me.m_scRes2, "m_scRes2")
            Me.m_scRes2.Name = "m_scRes2"
            '
            'm_scRes2.Panel1
            '
            Me.m_scRes2.Panel1.Controls.Add(Me.m_graphResults)
            '
            'm_scRes2.Panel2
            '
            Me.m_scRes2.Panel2.Controls.Add(Me.m_gridResults)
            '
            'frmMPAOptimizations
            '
            ...
            Me.m_scResults.Panel2.ResumeLayout(False)
            ...
            Me.m_tlpParms.ResumeLayout(False)
            ...
            Me.m_tlpResults.ResumeLayout(False)
            Me.m_plResults.ResumeLayout(False)
            Me.m_plResults.PerformLayout()
            Me.m_scRes2.Panel1.ResumeLayout(False)
            Me.m_scRes2.Panel2.ResumeLayout(False)
            CType(Me.m_scRes2, System.ComponentModel.ISupportInitialize).EndInit()
            Me.m_scRes2.ResumeLayout(False)
        ...
        Private WithEvents m_tlpParms As TableLayoutPanel
        Private WithEvents m_scResults As SplitContainer
        Private WithEvents m_tsMap As cEwEToolstrip
        Private WithEvents m_tsbMPA As ToolStripDropDownButton
        Private WithEvents m_tsmClearMPA As ToolStripMenuItem
        Private WithEvents m_tsmSetAllMPA As ToolStripMenuItem
        Private WithEvents m_tsbSeed As ToolStripDropDownButton
        Private WithEvents m_tsmClearSeed As ToolStripMenuItem
        Private WithEvents m_tsmSetAllSeed As ToolStripMenuItem
        Private WithEvents m_tsbEditLayers As ToolStripButton
        Private WithEvents m_tlpResults As TableLayoutPanel
        Private WithEvents m_plResults As Panel
        Private WithEvents m_scRes2 As SplitContainer
    End Class
End Namespace
